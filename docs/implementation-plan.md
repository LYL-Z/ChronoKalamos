...
| 11. 长安精品内容 | 27事件、12 NPC、8地点和来源台账通过技术发布门禁 | 已公开为 provisional；外部学者审阅仍待核验 |
| 12. 商业级上手 | 真实存档、设置、支持、证据筛选、联动时间轴和可访问性通过 | 已完成工程验收 |
| 13. 生产可靠性 | 迁移、RLS、RPC、Storage、Cloudflare与回滚边界明确 | 已完成代码硬化；控制台限制项持续记录 |
| 14. 小规模公开测试 | 真实参与者与历史审阅证据达到双门槛 | 实现已验证；外部证据不足，不能称商业级完成 |
| 15. 档案式社会模拟 | 三行动日循环、七系统入口、阶层边界、桌面和移动体验通过 | 工程验收通过并公开发布 Sites v38；不得扩展品官或帝王玩法 |
